...
<template>
  <section class="bg-primary-gray">
    <div class="container py-10 flex flex-col gap-14">
      <div
        class="bg-primary-blue p-4 sm:p-7 md:p-10 flex flex-col gap-10 md:flex-row text-white"
      >
        <div>
      ...
      <div class="bg-white p-4 sm:p-7 md:p-10 flex flex-col gap-6">
        ...
        <p>
          ...
          fuga quod a, cumque error recusandae aliquid facilis perspiciatis
          veniam ducimus. Voluptatum accusantium expedita repudiandae, ducimus
          minus veniam. Voluptates, amet porro!
        </p>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore
          fuga quod a, cumque error recusandae aliquid facilis perspiciatis
        ...
        <img
          class="w-full max-h-[90vh] object-cover object-center"
