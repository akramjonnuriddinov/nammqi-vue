<template>
  <section>
    <div class="container grid grid-cols-4 py-10 bg-white p-4">
      <div class="col-span-3">
        <NewsTopCardVue />
      </div>
      <div class="col-span-1">
        <div class="telegramBg text-sm p-3 rounded-md">
          ...
          <a
            ...
            class="bg-white rounded-md p-1 px-3 text-[#4fa4de] font-medium hover:text-white hover:bg-white/30 transition-all"
            >A'zo bo'lish</a
          >
        </div>
      </div>
