    ...
    <div class="container flex flex-col mx-auto px-4">
      ...
      <div class="flex gap-7">
        <div
          ...
          class="h-[450px] relative transition-all duration-500 ease-in-out"
          :class="{
        ...
        >
          ...
          <div class="absolute inset-0 bg-black/60">
            <div
              class="flex absolute inset-0 items-end text-white text-sm leading-tight p-7"
            >
              <div
                ...
                :class="
                  activeIndex !== index
                    ...
                    : 'duration-500  opacity-1 visible delay-500'
                "
              >
                <h3 class="text-3xl font-bold">{{ image.alt }}</h3>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Nesciunt quod laborum tempora veniam doloremque eaque
                  explicabo nulla minus doloribus minima? Ea nostrum aut
                  quisquam saepe ad consectetur sapiente quod asperiores.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <h3
                class="vertical-text text-white transition-all text-3xl font-bold"
                :class="
                  activeIndex === index
                    ? 'duration-100  opacity-0 invisible'
                    : 'duration-500  delay-500 opacity-1 visible'
                "
              >
                {{ image.alt }}
              </h3>
