...
<template>
  ...
  >
    <div class="w-full h-64 lg:h-80 relative">
      ...
      />
      <div
        class="absolute px-4 py-2 mb-3 font-bold top-10 left-0 uppercase bg-primary-blue text-white"
      >
        ВАЖНО
      </div>
    </div>
    <div class="h-full p-6 text-white bg-primary-blue">
      ...
      <p class="mt-2 text-sm opacity-75">
        «Поймать» ранее неизвестные бактерии удалось с помощью метагеномного
        анализа.
      </p>
      <RouterLink
        to="news/news-detail"
